...
## Sequence
   ...
   ```sequence
   dongle --> echo: MCTT (JKEY_ISSUEID_DR_WIN)
   ```
...
#define JKEY_ISSUEID_DR_WIN                      0x0001000A // door
   ```
### Command - JVAL_METHODID_PUT & JKEY_ISSUEID_DR_WIN
   ```
...
#### Sample
   ...
   ```
### Report - JVAL_METHODID_EVENT & JKEY_ISSUEID_DR_WIN
   ```
typedef struct
{
...
zwifd_alrm_door_closed_report_bin(ZWARE_REPORTER());
   ```

# Log
## MCTT
   ```
20210414 133902 [0/2-ZWAVES2] - <-- 9C65F9361C00/D808ACB4/0x0002/0 - zevent=0x0002.0,door,open
   ```

## TOPIC
   ```

[3613/3614] bee_topic_issue_cb:92 - (topic: 0/2/9C65F9361C00/D808ACB4/2/0/0001000A, value: {"name":"Door/Window sensor","val":"open"})
   ```
