...
{
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_BASIC].name, "CC_BASIC"); // 0x20

	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_CONTROLLER_REPLICATION].name, "CC_CONTROLLER_REPLICATION"); // 0x21
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_APPLICATION_STATUS].name, "CC_CLASS_APPLICATION_STATUS"); // 0x22
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_ZIP].name, "CC_CLASS_ZIP"); // 0x23
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_SWITCH_BINARY].name, "CC_SWITCH_BINARY"); // 0x25

	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_SWITCH_MULTILEVEL].name, "CC_SWITCH_MULTILEVEL"); // 0x26
	
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_SWITCH_ALL].name, "CC_SWITCH_ALL"); // 0x27
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_SCENE_ACTIVATION].name, "CC_SCENE_ACTIVATION"); // 0x2b
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_SCENE_ACTUATOR_CONF].name, "CC_SCENE_ACTUATOR_CONF"); // 0x2c
	
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_SENSOR_BINARY].name, "CC_SENSOR_BINARY"); // 0x30
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_SENSOR_MULTILEVEL].name, "CC_SENSOR_MULTILEVEL"); // 0x31
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_METER].name, "CC_METER"); // 0x32
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_SWITCH_COLOR].name, "CC_SWITCH_COLOR"); // 0x33
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_NETWORK_MANAGEMENT_INCLUSION].name, "CC_NETWORK_MANAGEMENT_INCLUSION"); // 0x34

	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_THERMOSTAT_MODE].name, "CC_THERMOSTAT_MODE"); // 0x40
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_THERMOSTAT_OPERATING_STATE].name, "CC_THERMOSTAT_OPERATING_STATE"); // 0x42
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_THERMOSTAT_SETPOINT].name, "CC_THERMOSTAT_SETPOINT"); // 0x43
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_THERMOSTAT_FAN_MODE].name, "CC_THERMOSTAT_FAN_MODE"); // 0x44
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_THERMOSTAT_FAN_STATE].name, "CC_THERMOSTAT_FAN_STATE"); // 0x45
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_DOOR_LOCK_LOGGING].name, "CC_DOOR_LOCK_LOGGING"); // 0x4c
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_NETWORK_MANAGEMENT_BASIC].name, "CC_CLASS_NETWORK_MANAGEMENT_BASIC"); // 0x4d
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_SCHEDULE_ENTRY_LOCK].name, "CC_SCHEDULE_ENTRY_LOCK"); // 0x4e

	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_NETWORK_MANAGEMENT_PROXY].name, "CC_CLASS_NETWORK_MANAGEMENT_PROXY"); // 0x52
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_TRANSPORT_SERVICE].name, "CC_TRANSPORT_SERVICE"); // 0x55
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_CRC_16_ENCAP].name, "CC_CRC_16_ENCAP"); // 0x56
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_ASSOCIATION_GRP_INFO].name, "CC_ASSOCIATION_GRP_INFO"); // 0x59
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_DEVICE_RESET_LOCALLY].name, "CC_DEVICE_RESET_LOCALLY"); // 0x5a
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_CENTRAL_SCENE].name, "CC_CENTRAL_SCENE"); // 0x5b
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_IP_ASSOCIATION].name, "CC_IP_ASSOCIATION"); // 0x5c
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_ZWAVEPLUS_INFO].name, "CC_ZWAVEPLUS_INFO"); // 0x5e
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_ZIP_GATEWAY].name, "CC_ZIP_GATEWAY"); // 0x5f
	
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_MULTI_CHANNEL_V2].name, "CC_MULTI_CHANNEL_V2"); // 0x60
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_ZIP_PORTAL].name, "CC_ZIP_PORTAL"); // 0x61
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_DOOR_LOCK].name, "CC_DOOR_LOCK"); // 0x62

	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_USER_CODE].name, "CC_USER_CODE"); // 0x63
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_NETWORK_MANAGEMENT_INSTALLATION_MAINTENANCE].name, "CC_NETWORK_MANAGEMENT_INSTALLATION_MAINTENANCE"); // 0x67
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_ZIP_NAMING].name, "CC_ZIP_NAMING"); // 0x68
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_MAILBOX].name, "CC_MAILBOX"); // 0x69
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_SUPERVISION].name, "CC_SUPERVISION"); // 0x6c

	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_CONFIGURATION].name, "CC_CONFIGURATION"); // 0x70
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_ALARM].name, "CC_ALARM"); // 0x71
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_MANUFACTURER_SPECIFIC].name, "CC_MANUFACTURER_SPECIFIC"); // 0x72

	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_POWERLEVEL].name, "CC_POWERLEVEL"); // 0x73
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_INCLUSION_CONTROLLER].name, "CC_INCLUSION_CONTROLLER"); // 0x74

	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_PROTECTION].name, "CC_PROTECTION"); // 0x75
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_NODE_NAMING].name, "CC_NODE_NAMING"); // 0x77
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_FIRMWARE_UPDATE_MD].name, "CC_FIRMWARE_UPDATE_MD"); // 0x7a
	
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_BATTERY].name, "CC_BATTERY"); // 0x80
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_CLOCK].name, "CC_CLOCK"); // 0x81
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_WAKE_UP].name, "CC_WAKE_UP"); // 0x84
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_ASSOCIATION].name, "CC_ASSOCIATION"); // 0x85
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_VERSION].name, "CC_VERSION"); // 0x86
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_TIME].name, "CC_TIME"); // 0x8a
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_TIME_PARAMETERS].name, "CC_TIME_PARAMETERS"); // 0x8b
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_MULTI_CHANNEL_ASSOCIATION_V2].name, "CC_MULTI_CHANNEL_ASSOCIATION_V2"); // 0x8e
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_MULTI_CMD].name, "CC_MULTI_CMD"); // 0x8f

	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_SIMPLE_AV_CONTROL].name, "CC_SIMPLE_AV_CONTROL"); // 0x94

	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_SECURITY].name, "CC_SECURITY"); // 0x98
	SAFE_SPRINTF(CommandClassArray[COMMAND_CLASS_SECURITY_2].name, "CC_SECURITY_2"); // 0x9f
...
{
	// ** SensorName **
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TEMP].name, "ZW_SENSOR_TYPE_TEMP"); // 0x01
	SensorNameArray[ZW_SENSOR_TYPE_TEMP].report = JKEY_REPORT_TEMPERATURE;
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TEMP].unit[ZW_SENSOR_UNIT_TEMP_CEL], "Celsius"); // 0x01.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TEMP].unit[ZW_SENSOR_UNIT_TEMP_FAHR], "Fahrenheit"); // 0x01.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_GP].name, "ZW_SENSOR_TYPE_GP"); // 0x02
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_GP].unit[ZW_SENSOR_UNIT_GP_PERC], "%%"); // 0x02.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_GP].unit[ZW_SENSOR_UNIT_GP_NODIM], "ZW_SENSOR_UNIT_GP_NODIM"); // 0x02.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_LUM].name, "ZW_SENSOR_TYPE_LUM"); // 0x03
	SensorNameArray[ZW_SENSOR_TYPE_LUM].report = JKEY_REPORT_LUMINANCE;
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_LUM].unit[ZW_SENSOR_UNIT_LUM_PERC], "%%"); // 0x03.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_LUM].unit[ZW_SENSOR_UNIT_LUM_LUX], "Lux"); // 0x03.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_POW].name, "ZW_SENSOR_TYPE_POW"); // 0x04
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_POW].unit[ZW_SENSOR_UNIT_POW_W], "w"); // 0x04.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_POW].unit[ZW_SENSOR_UNIT_POW_BTU], "Btu/h"); // 0x04.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_HUMD].name, "ZW_SENSOR_TYPE_HUMD"); // 0x05
	SensorNameArray[ZW_SENSOR_TYPE_HUMD].report = JKEY_REPORT_HUMIDITY;
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_HUMD].unit[ZW_SENSOR_UNIT_HUMD_PERC], "%%"); // 0x05.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_HUMD].unit[ZW_SENSOR_UNIT_HUMD_ABS], "g/m3"); // 0x05.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_VELO].name, "ZW_SENSOR_TYPE_VELO"); // 0x06
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_VELO].unit[ZW_SENSOR_UNIT_VELO_MS], "m/s"); // 0x06.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_VELO].unit[ZW_SENSOR_UNIT_VELO_MPH], "mph"); // 0x06.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_DIR].name, "ZW_SENSOR_TYPE_DIR"); // 0x07
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_DIR].unit[ZW_SENSOR_UNIT_DIR_DEG], "degrees"); // 0x07.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ATM].name, "ZW_SENSOR_TYPE_ATM"); // 0x08
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ATM].unit[ZW_SENSOR_UNIT_ATM_KPA], "kPa"); // 0x08.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ATM].unit[ZW_SENSOR_UNIT_ATM_HG], "inches of Mercury"); // 0x08.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_BARO].name, "ZW_SENSOR_TYPE_BARO"); // 0x09
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_BARO].unit[ZW_SENSOR_UNIT_BARO_KPA], "kPa"); // 0x09.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_BARO].unit[ZW_SENSOR_UNIT_BARO_HG], "inches of Mercury"); // 0x09.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SLR].name, "ZW_SENSOR_TYPE_SLR"); // 0x0A
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SLR].unit[ZW_SENSOR_UNIT_SLR_WM2], "W/m2"); // 0x0A.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_DEW].name, "ZW_SENSOR_TYPE_DEW"); // 0x0B
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_DEW].unit[ZW_SENSOR_UNIT_DEW_CEL], "Celsius"); // 0x0B.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_DEW].unit[ZW_SENSOR_UNIT_DEW_FAHR], "Fahrenheit"); // 0x0B.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_RAIN].name, "ZW_SENSOR_TYPE_RAIN"); // 0x0C
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_RAIN].unit[ZW_SENSOR_UNIT_RAIN_MMH], "mm/h"); // 0x0C.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_RAIN].unit[ZW_SENSOR_UNIT_RAIN_INH], "in/h"); // 0x0C.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TIDE].name, "ZW_SENSOR_TYPE_TIDE"); // 0x0D
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TIDE].unit[ZW_SENSOR_UNIT_TIDE_M], "m"); // 0x0D.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TIDE].unit[ZW_SENSOR_UNIT_TIDE_FT], "feet"); // 0x0D.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_WGT].name, "ZW_SENSOR_TYPE_WGT"); // 0x0E
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_WGT].unit[ZW_SENSOR_UNIT_WGT_KG], "kg"); // 0x0E.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_WGT].unit[ZW_SENSOR_UNIT_WGT_LBS], "pounds"); // 0x0E.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_VOLT].name, "ZW_SENSOR_TYPE_VOLT"); // 0x0F
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_VOLT].unit[ZW_SENSOR_UNIT_VOLT_V], "V"); // 0x0F.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_VOLT].unit[ZW_SENSOR_UNIT_VOLT_MV], "mV"); // 0x0F.0x01

	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_CUR].name, "ZW_SENSOR_TYPE_CUR"); // 0x10
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_CUR].unit[ZW_SENSOR_UNIT_CUR_A], "A"); // 0x10.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_CUR].unit[ZW_SENSOR_UNIT_CUR_MA], "mA"); // 0x10.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_CO2].name, "ZW_SENSOR_TYPE_CO2"); // 0x11
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_CO2].unit[ZW_SENSOR_UNIT_CO2_PPM], "ppm"); // 0x11.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_AIR].name, "ZW_SENSOR_TYPE_AIR"); // 0x12
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_AIR].unit[ZW_SENSOR_UNIT_AIR_M3H], "m3/h"); // 0x12.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_AIR].unit[ZW_SENSOR_UNIT_AIR_CFM], "cfm"); // 0x12.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TANK].name, "ZW_SENSOR_TYPE_TANK"); // 0x13
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TANK].unit[ZW_SENSOR_UNIT_TANK_L], "l"); // 0x13.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TANK].unit[ZW_SENSOR_UNIT_TANK_CBM], "cbm"); // 0x13.0x01
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TANK].unit[ZW_SENSOR_UNIT_TANK_GAL], "US gallons"); // 0x13.0x02
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_DIST].name, "ZW_SENSOR_TYPE_DIST"); // 0x14
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_DIST].unit[ZW_SENSOR_UNIT_DIST_M], "m"); // 0x14.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_DIST].unit[ZW_SENSOR_UNIT_DIST_CM], "cm"); // 0x14.0x01
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_DIST].unit[ZW_SENSOR_UNIT_DIST_FT], "feet"); // 0x14.0x02
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_AGL].name, "ZW_SENSOR_TYPE_AGL"); // 0x15
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_AGL].unit[ZW_SENSOR_UNIT_AGL_PERC], "%%"); // 0x15.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_AGL].unit[ZW_SENSOR_UNIT_AGL_DEGN], "degrees"); // 0x15.0x01
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_AGL].unit[ZW_SENSOR_UNIT_AGL_DEGS], "degrees"); // 0x15.0x02
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ROT].name, "ZW_SENSOR_TYPE_ROT"); // 0x16
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ROT].unit[ZW_SENSOR_UNIT_ROT_RPM], "rpm"); // 0x16.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ROT].unit[ZW_SENSOR_UNIT_ROT_HZ], "Hz"); // 0x16.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_WTR_TEMP].name, "ZW_SENSOR_TYPE_WTR_TEMP"); // 0x17
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_WTR_TEMP].unit[ZW_SENSOR_UNIT_WTR_TEMP_CEL], "Celsius"); // 0x17.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_WTR_TEMP].unit[ZW_SENSOR_UNIT_WTR_TEMP_FAHR], "Fahrenheit"); // 0x17.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SOIL_TEMP].name, "ZW_SENSOR_TYPE_SOIL_TEMP"); // 0x18
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SOIL_TEMP].unit[ZW_SENSOR_UNIT_SOIL_TEMP_CEL], "Celsius"); // 0x18.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SOIL_TEMP].unit[ZW_SENSOR_UNIT_SOIL_TEMP_FAHR], "Fahrenheit"); // 0x18.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SEIS_INT].name, "ZW_SENSOR_TYPE_SEIS_INT"); // 0x19
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SEIS_INT].unit[ZW_SENSOR_UNIT_SEIS_INT_MERC], "Mercalli"); // 0x19.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SEIS_INT].unit[ZW_SENSOR_UNIT_SEIS_INT_EMCRO], "European Macroseismic"); // 0x19.0x01
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SEIS_INT].unit[ZW_SENSOR_UNIT_SEIS_INT_LIEDU], "Liedu"); // 0x19.0x02
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SEIS_INT].unit[ZW_SENSOR_UNIT_SEIS_INT_SHNDO], "Shindo"); // 0x19.0x03
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SEIS_MAG].name, "ZW_SENSOR_TYPE_SEIS_MAG"); // 0x1A
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SEIS_MAG].unit[ZW_SENSOR_UNIT_SEIS_MAG_LOCAL], "Local (ML)"); // 0x1A.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SEIS_MAG].unit[ZW_SENSOR_UNIT_SEIS_MAG_MOM], "Moment (MW)"); // 0x1A.0x01
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SEIS_MAG].unit[ZW_SENSOR_UNIT_SEIS_MAG_SWAVE], "Surface wave (MS)"); // 0x1A.0x02
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SEIS_MAG].unit[ZW_SENSOR_UNIT_SEIS_MAG_BWAVE], "Body wave (MB"); // 0x1A.0x03
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_UV].name, "ZW_SENSOR_TYPE_UV"); // 0x1B
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_UV].unit[ZW_SENSOR_UNIT_UV_INDEX], "UV index"); // 0x1B.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ELEC_RES].name, "ZW_SENSOR_TYPE_ELEC_RES"); // 0x1C
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ELEC_RES].unit[ZW_SENSOR_UNIT_ELEC_RES_OHMM], "ohm metre"); // 0x1C.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ELEC_COND].name, "ZW_SENSOR_TYPE_ELEC_COND"); // 0x1D
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ELEC_COND].unit[ZW_SENSOR_UNIT_ELEC_COND_SIEM], "siemens per metre (S/m)"); // 0x1D.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_LOUDNESS].name, "ZW_SENSOR_TYPE_LOUDNESS"); // 0x1E
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_LOUDNESS].unit[ZW_SENSOR_UNIT_LOUDNESS_ABS], "Absolute loudness (dB)"); // 0x1E.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_LOUDNESS].unit[ZW_SENSOR_UNIT_LOUDNESS_A_WT], "A-weighted decibels (dBA)"); // 0x1E.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_MOIST].name, "ZW_SENSOR_TYPE_MOIST"); // 0x1F
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_MOIST].unit[ZW_SENSOR_UNIT_MOIST_PERC], "%%"); // 0x1F.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_MOIST].unit[ZW_SENSOR_UNIT_MOIST_VOL_WTR], "Volume water content (m3/m3)"); // 0x1F.0x01
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_MOIST].unit[ZW_SENSOR_UNIT_MOIST_IMPD], "Impedance (k ohm)"); // 0x1F.0x02
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_MOIST].unit[ZW_SENSOR_UNIT_MOIST_WTR_ACT], "Water activity (aw)"); // 0x1F.0x03

	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_FREQ].name, "ZW_SENSOR_TYPE_FREQ"); // 0x20
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_FREQ].unit[ZW_SENSOR_UNIT_FREQ_HZ], "Hz"); // 0x20.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_FREQ].unit[ZW_SENSOR_UNIT_FREQ_KHZ], "kHz"); // 0x20.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TIME].name, "ZW_SENSOR_TYPE_TIME"); // 0x21
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TIME].unit[ZW_SENSOR_UNIT_TIME_SEC], "seconds"); // 0x21.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TGT_TEMP].name, "ZW_SENSOR_TYPE_TGT_TEMP"); // 0x22
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TGT_TEMP].unit[ZW_SENSOR_UNIT_TGT_TEMP_CEL], "Celsius"); // 0x22.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TGT_TEMP].unit[ZW_SENSOR_UNIT_TGT_TEMP_FAHR], "Fahrenheit"); // 0x22.0x01

	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_PM_2_5].name, "ZW_SENSOR_TYPE_PM_2_5"); // 0x23
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_PM_2_5].unit[ZW_SENSOR_UNIT_PM_2_5_MM3], "mol/m3"); // 0x23.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_PM_2_5].unit[ZW_SENSOR_UNIT_PM_2_5_UGM3], "ug/m3"); // 0x23.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_F_CH2O].name, "ZW_SENSOR_TYPE_F_CH2O"); // 0x24
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_F_CH2O].unit[ZW_SENSOR_UNIT_F_CH2O_MM3], "mol/m3"); // 0x24.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_RAD_CONT].name, "ZW_SENSOR_TYPE_RAD_CONT"); // 0x25
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_RAD_CONT].unit[ZW_SENSOR_UNIT_RAD_CONT_BQM3], "bq/m3"); // 0x25.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_RAD_CONT].unit[ZW_SENSOR_UNIT_RAD_CONT_PCIL], "pCi/L"); // 0x25.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_METH_DENS].name, "ZW_SENSOR_TYPE_METH_DENS"); // 0x26
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_METH_DENS].unit[ZW_SENSOR_UNIT_METH_DENS_MM3], "mol/m3"); // 0x26.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_VOC].name, "ZW_SENSOR_TYPE_VOC"); // 0x27
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_VOC].unit[ZW_SENSOR_UNIT_VOC_MM3], "mol/m3"); // 0x27.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_CO_LVL].name, "ZW_SENSOR_TYPE_CO_LVL"); // 0x28
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_CO_LVL].unit[ZW_SENSOR_UNIT_CO_LVL_MM3], "mol/m3"); // 0x28.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SOIL_HUMD].name, "ZW_SENSOR_TYPE_SOIL_HUMD"); // 0x29
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SOIL_HUMD].unit[ZW_SENSOR_UNIT_CO_LVL_MM3], "%%"); // 0x29.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SOIL_REAC].name, "ZW_SENSOR_TYPE_SOIL_REAC"); // 0x2A
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SOIL_REAC].unit[ZW_SENSOR_UNIT_SOIL_REAC_PH], "pH"); // 0x2A.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SOIL_SAL].name, "ZW_SENSOR_TYPE_SOIL_SAL"); // 0x2B
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SOIL_SAL].unit[ZW_SENSOR_UNIT_SOIL_SAL_MM3], "mol/m3"); // 0x2B.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_HEART_RT].name, "ZW_SENSOR_TYPE_HEART_RT"); // 0x2C
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_HEART_RT].unit[ZW_SENSOR_UNIT_HEART_RT_BPM], "Bpm"); // 0x2C.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_BLOOD_PRS].name, "ZW_SENSOR_TYPE_BLOOD_PRS"); // 0x2D
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_BLOOD_PRS].unit[ZW_SENSOR_UNIT_BLOOD_PRS_SYS], "mmHg"); // 0x2D.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_BLOOD_PRS].unit[ZW_SENSOR_UNIT_BLOOD_PRS_DIA], "mmHg"); // 0x2D.0x01
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_MUSCLE_MS].name, "ZW_SENSOR_TYPE_MUSCLE_MS"); // 0x2E
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_MUSCLE_MS].unit[ZW_SENSOR_UNIT_MUSCLE_MS_KG], "kg"); // 0x2E.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_FAT_MS].name, "ZW_SENSOR_TYPE_FAT_MS"); // 0x2F
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_FAT_MS].unit[ZW_SENSOR_UNIT_FAT_MS_KG], "kg"); // 0x2F.0x00

	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_BONE_MS].name, "ZW_SENSOR_TYPE_BONE_MS"); // 0x30
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_BONE_MS].unit[ZW_SENSOR_UNIT_BONE_MS_KG], "kg"); // 0x30.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TBW].name, "ZW_SENSOR_TYPE_TBW"); // 0x31
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_TBW].unit[ZW_SENSOR_UNIT_TBW_KG], "kg"); // 0x31.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_BMR].name, "ZW_SENSOR_TYPE_BMR"); // 0x32
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_BMR].unit[ZW_SENSOR_UNIT_BMR_J], "J"); // 0x32.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_BMI].name, "ZW_SENSOR_TYPE_BMI"); // 0x33
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_BMI].unit[ZW_SENSOR_UNIT_BMI_IDX], "idx"); // 0x33.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ACCEL_X].name, "ZW_SENSOR_TYPE_ACCEL_X"); // 0x34
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ACCEL_X].unit[ZW_SENSOR_UNIT_ACCEL_X_MS2], "m/s2"); // 0x34.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ACCEL_Y].name, "ZW_SENSOR_TYPE_ACCEL_Y"); // 0x35
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ACCEL_Y].unit[ZW_SENSOR_UNIT_ACCEL_Z_MS2], "m/s2"); // 0x35.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ACCEL_Z].name, "ZW_SENSOR_TYPE_ACCEL_Z"); // 0x36
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_ACCEL_Z].unit[ZW_SENSOR_UNIT_ACCEL_Z_MS2], "m/s2"); // 0x36.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SMOKE_DEN].name, "ZW_SENSOR_TYPE_SMOKE_DEN"); // 0x37
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_SMOKE_DEN].unit[ZW_SENSOR_UNIT_SMOKE_DEN_PERC], "%%"); // 0x37.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_WATER_FLW].name, "ZW_SENSOR_TYPE_WATER_FLW"); // 0x38
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_WATER_FLW].unit[ZW_SENSOR_UNIT_WATER_FLW_LHR], "(l/h"); // 0x38.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_WATER_PRS].name, "ZW_SENSOR_TYPE_WATER_PRS"); // 0x39
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_WATER_PRS].unit[ZW_SENSOR_UNIT_WATER_PRS_KPA], "kPa"); // 0x39.0x00
	SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_RF_SGN].name, "ZW_SENSOR_TYPE_RF_SGN"); // 0x3A
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_RF_SGN].unit[ZW_SENSOR_UNIT_RF_SGN_RSSI], "%%"); // 0x3A.0x00
		SAFE_SPRINTF(SensorNameArray[ZW_SENSOR_TYPE_RF_SGN].unit[ZW_SENSOR_UNIT_RF_SGN_DBM], "dBm"); // 0x3A.0x00
}
...
void translater_open(void)
{
	...
	for (i=0; i< LEN_OF_2BYTES_DEFINE; i++)
	{
		...
		SAFE_SPRINTF(CommandClassArray[i].name, "XXX");
	}
	
	for (i=0; i< LEN_OF_1BYTE_DEFINE; i++)
	{
		//SensorNameArray[i].id = i;
		SAFE_SPRINTF(SensorNameArray[i].name, "ZW_SENSOR_TYPE_XXX");
		SensorNameArray[i].report = JKEY_REPORT_XXX;
		int j = 0;
		for (j=0; j< 0xF; j++)
		{
			SAFE_SPRINTF(SensorNameArray[i].unit[j], "UNIT_XXX");
		}
	}
#endif
